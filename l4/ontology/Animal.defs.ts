/// <mls fileReference="_102034_/l4/ontology/Animal.defs.ts" enhancement="_blank"/>

import type { MdmEntityArtifact } from '/_102034_/l1/mdm/defs/ontologyTypes.js';

export const mdmEntityAnimal = {
    ...
    "details": {
      ...
      "fields": {
        ...
        "registrationNumber": {
          ...
          "description": "Breed registry, USDA tag, or official animal ID.",
          "required": false,
          "nullable": true,
          "origin": "nivel1",
          "layer": "document",
...
export type MdmEntityAnimalType = typeof mdmEntityAnimal;

export default mdmEntityAnimal;
