/// <mls fileReference="_102034_/l4/ontology/ContactChannel.defs.ts" enhancement="_blank"/>

import type { MdmEntityArtifact } from '/_102034_/l1/mdm/defs/ontologyTypes.js';

export const mdmEntityContactChannel = {
  "schemaVersion": "2026-09-15-mdm-ontology-v1",
  "kind": "entity",
  "entityId": "ContactChannel",
  ...
  "fields": {
    ...
    "details": {
      ...
      "fields": {
        ...
        "value": {
          "title": "Value",
          "description": "Full contact value. Stored unmasked.",
          "required": true,
          "origin": "nivel1",
          "layer": "document",
          "type": "string"
...
export type MdmEntityContactChannelType = typeof mdmEntityContactChannel;

export default mdmEntityContactChannel;
