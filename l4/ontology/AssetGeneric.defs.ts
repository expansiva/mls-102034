/// <mls fileReference="_102034_/l4/ontology/AssetGeneric.defs.ts" enhancement="_blank"/>

import type { MdmEntityArtifact } from '/_102034_/l1/mdm/defs/ontologyTypes.js';

export const mdmEntityAssetGeneric = {
  "schemaVersion": "2026-09-15-mdm-ontology-v1",
  "kind": "entity",
  "entityId": "AssetGeneric",
  "title": "Asset Generic",
    ...
    "details": {
      ...
      "fields": {
        ...
        "assetCategory": {
          ...
          "description": "Examples: furniture, lab-item, signage, toolkit, decor.",
          "required": false,
          "nullable": true,
          "origin": "nivel1",
          "layer": "document",
...
export type MdmEntityAssetGenericType = typeof mdmEntityAssetGeneric;

export default mdmEntityAssetGeneric;
