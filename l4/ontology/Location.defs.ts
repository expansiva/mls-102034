/// <mls fileReference="_102034_/l4/ontology/Location.defs.ts" enhancement="_blank"/>

import type { MdmEntityArtifact } from '/_102034_/l1/mdm/defs/ontologyTypes.js';

export const mdmEntityLocation = {
    ...
    "details": {
      ...
      "fields": {
        ...
        "parentLocationId": {
          ...
          "description": "Optional parent mdmId when this place belongs to a larger place.",
          "required": false,
          "nullable": true,
          "origin": "nivel1",
          "layer": "document",
...
export type MdmEntityLocationType = typeof mdmEntityLocation;

export default mdmEntityLocation;
