...
export const mdm = {
  ...
  "capabilities": {
    ...
    "locate.byDocumentField": "Filters or sorts by something that lives only in the document, such as birth month, city or any module field · would need that field promoted to an index column, or a GIN index on details · marketing and reporting · platform: missing",
